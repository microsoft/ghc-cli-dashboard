...
Headline numbers, top projects, and model and provider mix:

![Overview section showing summary cards, a top-projects bar chart, model and provider donut charts, and a reasoning-effort bar chart](docs/images/overview.png)
